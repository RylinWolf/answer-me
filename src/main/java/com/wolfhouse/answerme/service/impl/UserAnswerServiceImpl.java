...
import com.wolfhouse.answerme.mapper.UserAnswerMapper;
...
public class UserAnswerServiceImpl extends ServiceImpl<UserAnswerMapper, UserAnswer> implements UserAnswerService {
    ...
    public Page
        ...
        Page<UserAnswerVO> userAnswerVOPage = new Page<>(userAnswerPage.getCurrent(),
                                                         userAnswerPage.getSize(),
                                                         userAnswerPage.getTotal());
        ...
        // region 可选
        // 1. 关联查询用户信息
        Set<Long> userIdSet = userAnswerList.stream()
