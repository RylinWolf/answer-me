...
import com.wolfhouse.answerme.mapper.AppMapper;
import com.wolfhouse.answerme.model.dto.app.AppQueryRequest;
...
import com.wolfhouse.answerme.model.enums.ScoringStrategyEnum;
import com.wolfhouse.answerme.model.vo.AppVO;
...
// todo 从对象中取值
        ...
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 80, ErrorCode.PARAMS_ERROR, "应用名称过长 要小于80");
        }
