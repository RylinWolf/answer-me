...
import com.wolfhouse.answerme.mapper.QuestionMapper;
import com.wolfhouse.answerme.model.dto.question.QuestionQueryRequest;
...
//  从对象中取值
    ...
    public Page
        ...
        // 对象列表 => 封装对象列表
        List
            <QuestionVO> questionVOList = questionList.stream()
                                                      .map(question -> {
