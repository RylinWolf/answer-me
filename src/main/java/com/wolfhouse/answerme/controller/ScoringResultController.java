...
import com.wolfhouse.answerme.model.dto.scoringresult.ScoringResultAddRequest;
import com.wolfhouse.answerme.model.dto.scoringresult.ScoringResultEditRequest;
import com.wolfhouse.answerme.model.dto.scoringresult.ScoringResultQueryRequest;
import com.wolfhouse.answerme.model.dto.scoringresult.ScoringResultUpdateRequest;
...
// region 增删改查
    ...
    @PostMapping("/add")
    public BaseResponse
        <Long> addScoringResult(@RequestBody ScoringResultAddRequest scoringResultAddRequest,
    ...
    public BaseResponse
        ...
        Page<ScoringResult> scoringResultPage = scoringResultService.page(new Page<>(current, size),
                                                                          scoringResultService.getQueryWrapper(
    ...
    public BaseResponse
        <Page
            <ScoringResultVO>> listMyScoringResultVOByPage(
        @RequestBody ScoringResultQueryRequest scoringResultQueryRequest,
        HttpServletRequest request) {
