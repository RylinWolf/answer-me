...
import com.wolfhouse.answerme.constant.FileConstant;
import com.wolfhouse.answerme.exception.BusinessException;
import com.wolfhouse.answerme.manager.CosManager;
import com.wolfhouse.answerme.model.dto.file.UploadFileRequest;
import com.wolfhouse.answerme.model.entity.User;
import com.wolfhouse.answerme.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    private void validFile(MultipartFile multipartFile, FileUploadBizEnum fileUploadBizEnum) {
        ...
        if (FileUploadBizEnum.USER_AVATAR.equals(fileUploadBizEnum)) {
            ...
            if (!Arrays.asList("jpeg", "jpg", "svg", "png", "webp")
                       .contains(fileSuffix)) {
